...
from rsl_rl.modules import ActorCriticRL2, ActorCriticRecurrent
...
class DEBUGPPO:
    ...
    def update(self):  # noqa: C901
        ...
        if self.policy.is_recurrent:
            generator = self.storage.debug_chunk_mini_batch_generator(self.num_mini_batches, self.num_learning_epochs, chunk_size=48)
        else:
